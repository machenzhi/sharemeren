...
<c:if test="${fn:length(typeMenuList) ne 0}">
	<div class="am-panel am-panel-primary am-show-md-up"
		...
		<ul class="am-list am-list-static">
			<c:forEach items="${typeMenuList}" var='typeMenu'>
				<li style="height: 35px; padding-top: 5px;"><a
					...
					onclick="initContent('../../${typeMenu.url}&typename=${typeMenu.name}&typeid=${typeMenu.id}&typepath=${typeMenu.abspath}&htmlName=${typeMenu.id}_1')">
						${typeMenu.name} </a></li>
			</c:forEach>
		</ul>
	</div>
