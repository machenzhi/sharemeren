...
<script type="text/javascript">
	...
	$(function() {
		...
		initContent('${basePath}news/getNewsListPage.do')
	});
		...
		<div class="am-collapse am-topbar-collapse" id="topbar-collapse">
			<ul
				...
				<li><a href="javascript:void(0)"
					style="cursor: pointer; color: #EA88AC;"
				...
				<li><a href="javascript:void(0)"><span class="am-icon-user"></span>${user.truename}</a></li>
		...
		<div class="admin-sidebar am-offcanvas" id="scolldiv"
			...
			<div class="am-offcanvas-bar admin-offcanvas-bar">
				<ul class="am-list admin-sidebar-list">
					<li><a class="hoverMenu" href="javascript:void(0)"
						onclick="initContent('${basePath}news/getNewsListPage.do')"><span
							class="rx-FirstMenuColor am-icon-table"></span>&nbsp;信息管理</a></li>
					<li><a class="hoverMenu" href="javascript:void(0)"
						onclick="initContent('${basePath}common/gotopage.do?gotourl=dictionary/dictionary')"
						id="dictionary"><span
							class="rx-FirstMenuColor am-icon-puzzle-piece"></span>&nbsp;信息类型</a></li>
					<li><a class="hoverMenu" href="javascript:void(0)"
						onclick="initContent('${basePath}common/gotopage.do?gotourl=user/updatepassword')">
				...
				<div class="am-panel am-panel-default admin-sidebar-panel">
					<div class="am-panel-bd">
						...
						<p>
							晒迷人<br>电话：18103857686<br>Q Q：317605397
						</p>
						<a class="am-badge am-badge-success am-radius">IT定制专家</a>
					</div>
				</div>
			</div>
		</div>
