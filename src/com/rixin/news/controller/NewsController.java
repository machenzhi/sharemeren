...
public class NewsController {
	...
	public ModelAndView getMainContent(HttpServletRequest request, HttpServletResponse response, String htmlName) {
		...
		News news = new News();
		news.setPaging("yes");
		news.setTypepath("0.40b3488ed18a4c1a85f9fdb92f2965ff");
		List<News> mainNewsList = newsService.getNews(news);
	...
	public void getmianbaoMenu(HttpServletRequest request, String typepath) {
		...
		dic.setId("index");
		dic.setName("首页");
		dic.setAbspath("0.index");
		dic.setUrl("news/qiantai/getMainContent.do?demo=1");
		mianbaoList.add(dic);
