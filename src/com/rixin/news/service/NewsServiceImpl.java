...
public class NewsServiceImpl implements INewsService {
	...
	public void getPropNews(HttpServletRequest request) {
		...
		for (String key : propKeys) {
			...
			getNewsByDic(dictionary, key, request);
		}
	}
	 ...
	 * @param request
	 */
	private void getNewsByDic(Dictionary dictionary, String key, HttpServletRequest request) {
		if (dictionary != null) {
			News news = new News();
			...
			List<Dictionary> subTypes = dictionaryDao.getDictionarysByPid(dictionary.getId());
			request.setAttribute(key + "_SubTypes", subTypes);
			for (Dictionary dic : subTypes) {
				getNewsByDic(dic, key + "_SubNews", request);
			}
		}
	}
